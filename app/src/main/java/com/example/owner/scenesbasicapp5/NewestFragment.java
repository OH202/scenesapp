...
import com.example.owner.scenesbasicapp5.adapter.NewestAdapter;
...
public class NewestFragment extends Fragment implements AbsListView.OnScrollListener, AbsListView.OnItemClickListener{
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        if (mAdapter == null) {
            mAdapter = new NewestAdapter(getActivity(),android.R.layout.simple_list_item_1, generateData());
        }
    ...
    public static String publishSortCase(){

        String sortCase = "newest";
        return sortCase;
