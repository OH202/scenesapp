...
import com.example.owner.scenesbasicapp5.adapter.TrendingAdapter;
...
public class TrendingFragment extends Fragment implements AbsListView.OnScrollListener, AbsListView.OnItemClickListener{

    private static final String TAG = "ScenesApp";
    public static final String SAVED_DATA_KEY = "SAVED_DATA";
    public String sortCase = "trending";
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        if (mAdapter == null) {
            mAdapter = new TrendingAdapter(getActivity(),android.R.layout.simple_list_item_1, generateData());
        }
    ...
    public String publishSortCase(){

        String sortCase = "trending";
        return sortCase;
